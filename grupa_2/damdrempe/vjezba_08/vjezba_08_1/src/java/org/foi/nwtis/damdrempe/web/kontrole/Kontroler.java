 ...
 * @author grupa_2
 */
@WebServlet(name = "Kontroler", urlPatterns = {
    "/Kontroler", 
    "/PrijavaKorisnika", 
    "/OdjavaKorisnika", 
    "/ProvjeraKorisnika", 
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            switch(url){
                ...
                case "/ProvjeraKorisnika": 
                    //TODO provjerava u tablici polaznici i ako je uspjesno                    
                    String korime = request.getParameter("korime"); //iz login.jsp
                    ...
                    if(korime.equalsIgnoreCase("admin") && lozinka.equalsIgnoreCase("lozinka")){
                        ...
                        Korisnik k = new Korisnik(korime, "Damir", "Drempetic", id, 0, ip);
            ...
            if(odlazniUrl == null || odlazniUrl.equalsIgnoreCase("")){
