package org.foi.nwtis.damdrempe.web.filteri;
...
import org.foi.nwtis.damdrempe.web.kontrole.NeuspjesnaPrijava;

/**
 *
 * @author grupa_2
 */
@WebFilter(filterName = "KontrolaPristupa", urlPatterns = {"/privatno/*"}, dispatcherTypes = {DispatcherType.REQUEST, DispatcherType.FORWARD})
public class KontrolaPristupa implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        Object o = sesija.getAttribute("NWTiS_korisnik");
        if(o instanceof Korisnik){
            
        } else {
            throw new NeuspjesnaPrijava("Neautorizirani pristup stranici!");
        }
